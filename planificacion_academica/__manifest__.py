...
# Generado por el plugin Odoo V10 para Dia!
{
    ...
    'depends': ['base'],
    'data': ['security/ir.model.access.csv', 'views/PROYECTO_view.xml','data/estudiantes.sql','data/docentes.sql'],
    'demo': [ ],
    'css': [ ],
    'qweb': ['static/src/xml/form_view_disable_save_discard.xml'],
    'update_xml': [ ],
    'installable': True,
    'auto_install': False,
    'application': True,
